...
from lattice_qft.core.basic_operator_interface import BasicOperator
...
class PhiTensorXOperator(BasicOperator):  # remember to add phase circuit from states.py
    ...
    def build_operator_circuit(self, qregs, ancilla_qubits, params):
        ...
        qreg = qregs[0]
        param = params[0]
        return PhiTensorXOperator.phi_tensor_x(self, qreg, ancilla_qubits, param)
    ...
    def phase(self, Nq, prefactor):
        ...
        return (((2**Nq) - 1) / (2 * _dphi(Nq, self.phi_max))) * prefactor[0]
...
class PiTensorYOperator(BasicOperator):
    ...
    def build_operator_circuit(self, qregs, ancilla_qubits, params):
        ...
        qreg = qregs[0]
        param = params[0]
        return PiTensorYOperator.pi_tensor_y(self, qreg, ancilla_qubits, param)
